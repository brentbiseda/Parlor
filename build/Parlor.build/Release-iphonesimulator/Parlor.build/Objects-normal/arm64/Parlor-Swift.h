...
#ifndef PARLOR_SWIFT_H
#define PARLOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Parlor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC6Parlor11SportsScene")
@interface SportsScene : SKScene
...
@class UITouch;
@class UIEvent;
SWIFT_CLASS("_TtC6Parlor14AirHockeyScene")
@interface AirHockeyScene : SportsScene
...
SWIFT_CLASS("_TtC6Parlor13BreakoutScene")
...
SWIFT_CLASS("_TtC6Parlor14CentipedeScene")
@interface CentipedeScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)update:(NSTimeInterval)currentTime;
...
SWIFT_CLASS("_TtC6Parlor10DerbyScene")
@interface DerbyScene : SportsScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)update:(NSTimeInterval)currentTime;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC6Parlor14FieldGoalScene")
@interface FieldGoalScene : SportsScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
...
/// names travel inside <code>Envelope.hello</code> and the advertiser’s discovery info.
SWIFT_CLASS("_TtC6Parlor18MultipeerTransport")
@interface MultipeerTransport : NSObject
/// Joiner: browse for nearby tables; call <code>join(_:)</code> to connect.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@class NSData;
@class MCSession;
@interface MultipeerTransport (SWIFT_EXTENSION(Parlor)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface MultipeerTransport (SWIFT_EXTENSION(Parlor)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MultipeerTransport (SWIFT_EXTENSION(Parlor)) <MCSessionDelegate>
...
SWIFT_CLASS("_TtC6Parlor12PinballScene")
@interface PinballScene : SKScene <SKPhysicsContactDelegate>
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
...
SWIFT_CLASS("_TtC6Parlor13ShootoutScene")
@interface ShootoutScene : SportsScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC6Parlor17SolarStrikerScene")
@interface SolarStrikerScene : SKScene
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)update:(NSTimeInterval)currentTime;
